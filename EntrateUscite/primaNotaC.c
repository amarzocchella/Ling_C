 ...
 * ls
 * cd EntrateUscite
 * EntrateUscite gcc -Wall -g primaNotaC.c -o primaNotaC
 * EntrateUscite ./primaNotaC_c
...
int main()
{
  int entrate=0, uscite=0, importo;   
    ...
    printf(" Entrate= %d", entrate);
    printf(" Uscite = %d", uscite);
    printf(" Saldo  = %d", entrate+uscite);
     printf(" \n");
 }

/* test
~/LingC$ gcc -Wall -g primaNotaC.c -o primaNotaC
~/LingC$ ./primaNotaC_c
